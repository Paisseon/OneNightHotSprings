...
translate el strings:
    ...
    new "Είσαι σίγουρος οτι θες να διαγράχεις αυτή την αποθήκευση;"


    old "Are you sure you want to overwrite your save?"
    new "Είσαι σίγουρος οτι θες να αντικαταστήσεις την αποθήκευση σου;"


    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Η φόρτωση θα προκαλέσει τη διαγραφή μη αποθηκευμένης προόδου\nΕίσαι σίγουρος οτι θες να το κάνεις αυτό;"


    old "Are you sure you want to quit?"
    new "Είσαι σίγουρος οτι θες να φύγεις;"


    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "Είσαι σίγουρος οτι θες να γυρίσεις στο κυρίως μενού;\nΈτσι θα χάσεις τη μη αποθηκευμένη πρόοδο."


    old "Are you sure you want to begin skipping?"
    new "Είσαι σίγουρος οτι θες να ξεκινήσεις το προσπέρασμα;"


    old "Are you sure you want to skip to the next choice?"
    new "Είσαι σίγουρος οτι θες να προσπεράσεις στην επόμενη επιλογή;"


    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "Είσαι σίγουρος οτι θες να προσπεράσεις μη ορατό διάλογο στην επόμενη επιλογή;"


    old "Failed to save screenshot as %s."
    new "Αποτυχία αποθήκευσης στιγμιοτύπου ως %s."


    old "Saved screenshot as %s."
    new "Αποθήκευση στιγμιοτύπου ως %s."


    old "Self-voicing disabled."
    new "Αυτόματη ομιλία απενεργοποιημένη."


    old "Clipboard voicing enabled. "
    new "Φωνή προχείρου ενεργοποιημένη."


    old "Self-voicing enabled. "
    new "Αυτόματη ομιλία ενεργοποιημένη."


    old "Skip Mode"
    new "Λειτουργία Προσπέρασης"
    ...
    new "Φωνή προχείρου ενεργοποιημένη. Πάτα 'shift+C' για απενεργοποίηση."


    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "Η αυτόματη ομιλία θα έλεγε \"[renpy.display.tts.last]\". Πάτα 'alt+shift+V' για απενεργοποίηση."


    old "Self-voicing enabled. Press 'v' to disable."
    new "Αυτόματη ομιλία ενεργοποιημένη. Πάτα 'v' για απενεργοποίηση."
